  ...
  return (
    <div className="row">
      <div className="col s6 offset-s3">
          ...
          <div className="card-content black-text">
            ...
            <div>
              ...
              <div className="input-field">
                ...
                <span className="helper-text" data-error={`${errorField.name.message}`} data-success="The field is correct">The field should not empty</span>
              </div>
              <div className="input-field">
                <input
                  id="surname"
                ...
                <span className="helper-text" data-error={`${errorField.surname.message}`} data-success="The field is correct">The field should not empty</span>
              </div>
            </div>
          </div>
        ...
        <Link to={'/login'} className={'btn green darken-1'}>Sign in</Link>
      </div>
    </div>
  )
}