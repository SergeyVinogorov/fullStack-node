...
export const useValidateField = () => {
  ...
  const validationHandler = (name, value) => {
    const validator = {
      name: (str) => {return isEmptyHandler(str)},
      surname: (str) => {return isEmptyHandler(str)},
      email: (str) => {return emailHandler(str)},
      password: (str) => {return passwordHandler(str)},
    }
    try {
  ...
  const clearErrorField = useCallback(() => setErrorField({
    name: {isNotValid: false, message: '' },
    surname: {isNotValid: false, message: '' },
    email: {isNotValid: false, message: '' },
    password: {isNotValid: false, message: '' },
